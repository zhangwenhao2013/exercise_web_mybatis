...
INSERT INTO `message` VALUES (6, '彩票', '中奖号码', '查啥呀);
...
insert into command_content
values (2, '这是一个横精彩的内容', 1);

insert into command_content
values (3, '老子是一个段子手', 2);

insert into command_content
values (4, '如果你的月薪是3000块钱，请记得分成五份，一份用来买书，一份给家人，一份给女朋友买化妆品和衣服，一份请朋友们吃饭，一份作为同事的各种婚丧嫁娶的份子钱。剩下的2999块钱藏起来，不要告诉任何人', 2);
...
insert into command_content
values (7, '昨日，邓超在微博分享了自己和孙俪的书法。夫妻同样写幸福，但差距很大。邓超自己都忍不住感慨字丑：左边媳妇写的。右边是我写的。看完我再也不幸福了。', 4);

insert into command_content
values (8,
        '《忍者神龟》[2]真人电影由美国派拉蒙影业发行，《洛杉矶之战》导演乔纳森·里贝斯曼执导。 \r\n片中四只神龟和老鼠老师都基于漫画和卡通重新绘制，由动作捕捉技术实现。\r\n其中皮特·普劳泽克饰演达芬奇(武器：武士刀)，诺尔·费舍饰演米开朗基罗(武器：双节棍)，阿伦·瑞奇森饰演拉斐尔(武器：铁叉)，杰瑞米·霍华德饰演多拉泰罗(武器：武士棍)。\r\n该片计划于2014年8月8日在北美上映。',
        5);

insert into command_content
values (9, '查啥呀查，你不会中奖的！', 6);

select a.ID C_ID, a.NAME, a.DESCRIPTION, b.ID, b.CONTENT, b.COMMAND_ID
from command a
         left join command_content b on b.COMMAND_ID = a.ID
where 1 = 1
  and a.NAME = '段子'
  and a.DESCRIPTION = '精彩段子';
